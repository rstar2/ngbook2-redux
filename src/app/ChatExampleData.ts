...
export default function ChatExampleData(store: Store<AppState>) {
  ...
  store.dispatch(ThreadsActions.addMessage(tLadycap, {
    author: me,
  ...
  store.dispatch(ThreadsActions.addThread(tEcho));
  store.dispatch(ThreadsActions.addMessage(tEcho, {
    author: echo,
    sentAt: moment().subtract(1, 'minutes').toDate(),
    text: 'I\'ll echo whatever you send me'
  }));

  store.dispatch(ThreadsActions.addThread(tRev));
  store.dispatch(ThreadsActions.addMessage(tRev, {
    author: rev,
    sentAt: moment().subtract(3, 'minutes').toDate(),
    text: 'I\'ll reverse whatever you send me'
  }));

  store.dispatch(ThreadsActions.addThread(tWait));
  store.dispatch(ThreadsActions.addMessage(tWait, {
    author: wait,
  ...
  store.dispatch(ThreadsActions.selectThread(tLadycap));
